            ...
            <form action="/users" method="POST">
                ...
                <div class="row g-2">
                    <div class="col-md-12">
                        <div class="row g-3">
                            <div class="col md-12 text-center mb-5">
                                ...
                                <h3 class="text-white">Register Makaan</h3>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <input type="password" class="form-control border-0 py-3" placeholder="Confirm Password"
                    ...
                    <div class="col-md-12 mt-5">
                        <button type="submit" class="btn btn-dark border-0 w-100 py-3">Register</button>
                    </div>
                </div>
            </form>
        </div>
